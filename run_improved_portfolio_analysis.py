"""
Suggested File Name: run_improved_portfolio_analysis.py
File Location: /Users/robertpadgett/Projects/01_My_Notebooks/500_ED_Risk_Retro_BP/
Use: Execute the improved portfolio risk analysis with better table formatting
"""
...
from src.analysis.portfolio_risk_analyzer_improved import PortfolioRiskAnalyzer

def main():
    """Run improved portfolio analysis with better visualization"""
    print("=" * 80)
    print("🚀 ENERGIZE DENVER PORTFOLIO RISK ANALYSIS - IMPROVED")
    print("=" * 80)
    print(f"Analysis Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("Using corrected penalty rates: Standard=$0.15/kBtu, ACO=$0.23/kBtu")
    print("Improvements: Better table formatting, added 2032 column")
    print("=" * 80)
    ...
    try:
        ...
        output_path = os.path.join(output_dir, f'portfolio_risk_analysis_improved_{datetime.now().strftime("%Y%m%d_%H%M%S")}.json')
        ...
        print("   - Table labels now wrap properly")
        print("   - Added 'Avg $/sqft 2032' column for ACO comparison")
        print("   - Better header styling in summary table")
        print("   - Executive Summary sheet added to Excel output")
...
if __name__ == "__main__":
    success = main()
    if success:
        print("\n✅ Improved portfolio analysis completed successfully!")
    else:
